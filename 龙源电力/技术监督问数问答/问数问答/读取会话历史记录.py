...
request_path = "/digital-artisan-analyze/data/api/getChatHistory?conversationId=9e3bcf35577a4ed49dd551c5c68f48e9"              # route URI
...
print(f"""curl -X GET -i 'http://10.170.249.86:9901{request_path}' \\
 -H "Date: {headers['Date']}" \\
