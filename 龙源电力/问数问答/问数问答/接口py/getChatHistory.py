...
request_path = "/digital-artisan-analyze/data/api/getChatHistory?conversationId=null"              # route URI
...
try:
    response = requests.get( url,headers=headers, data=body_json.encode('utf-8'))
