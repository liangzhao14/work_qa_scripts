...
if __name__ == "__main__":
    ...
    # 应用管理 -> 应用详情 -> AppID(复制)
    APP_ID = "65E7CDB749E944ABA428"
    # 应用管理 -> 应用详情 -> App Secret Key(复制)
    APP_SECRET = "F04EA6AD17DD4C9DBFB34709F82FE1B0"
    # 应用管理 -> 应用详情 -> 关联数据列表 -> 编码(复制)
    BODY_ID = "xzrbgent3jocnppyyl3vuznzz13jf6vv"
    ...
    path = 'input/装备售后运维助手（4x250）/济柴动力_售后助手_214.xlsx'
    response_document_path = fr'output/装备售后运维助手/chat_{num}路_{start_time}.xlsx'
