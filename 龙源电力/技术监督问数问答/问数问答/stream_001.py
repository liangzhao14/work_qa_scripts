...
request_path = "/digital-artisan-chat2/supervision/api/stream"              # route URI
algorithm= "hmac-sha256"           # can use other algorithms in allowed_algorithms
body = """
     {"assistantId":910,"regionRights":["黑龙江","北京"],"question":"123456","selectedDoc":["文档1","文档2"],"userId":"1a32ad12f32f"}
"""
...
print(f"""curl -N -X POST -i 'http://10.170.249.86:9901{request_path}' \\
 -H "Date: {headers['Date']}" \\
