...
class AskLLM():
    ...
    def ask_llm(self, question, assistantId, conversationId):
        ...
        body = {"content": question, "assistantId": assistantId, "conversationId": conversationId}
        paragraph = [""] * 10
        result = ""
...
if __name__ == '__main__':
    file_path = fr'D:/ZSY/test1121-1.xlsx'
    a = AskLLM(localhost="https://test-assistant.ai.cnpc", file_path=file_path)
    a.ask_llm(question="我的职务是科级，我去上海出差，我的住宿标准是多少", assistantId=1, conversationId="")
    # a.create_excel()