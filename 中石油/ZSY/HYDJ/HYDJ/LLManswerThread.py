...
localhost = "https://expert.kunlungpt.cn/"
df = pandas.read_excel(r'D:\项目\中石油\ZSY\ZSY\1128\basic\HYDJ\a.xlsx')
file_path = fr'D:\项目\中石油\ZSY\ZSY\1128\output\HYDJ\chat_{max_workers}路_{start_time}.xlsx'
...
for m in range(0,len(questions),20):
    ...
    AskLLM = LLManswerSingle.AskLLM(localhost=localhost,file_path=file_path,cookie={"i_c_u_a_t":"dc9ab4860d5e46eca7a4bf75ec04f006"})
